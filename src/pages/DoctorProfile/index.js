...
const DoctorProfile = ({navigation}) => {
    return (
        <View style={styles.page} >
            ...
            <Profile name="Crishtable Angesty" desc="Dokter Anak" />
            <Gap height={10} />
            <ProfileItem label="Alumnus" value="Universitas Indonesia, 2020" />
            <ProfileItem label="Tempat Praktek" value="Rumah Sakit Didi, Jakarta" />
            <ProfileItem label="No. STR" value="0001235476566" />
